...
def main():
    with open("str_yaml", encoding="utf-8") as f:
    ...
    cat = Cat(data["cat"]["name"], data["cat"]["color"], data["cat"]["age"], data["cat"]["sex"])
    cat.catch_mouse()
    ...
    dog = Dog(data["dog"]["name"], data["dog"]["color"], data["dog"]["age"], data["dog"]["sex"])
